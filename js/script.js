...
const PROJECTS = [
  ...
  {
    id: "p2",
    title:    "YOGA FLOW-BOOKING SYSTEM",
    category: "design",
    thumb:    "",
    grad:     "linear-gradient(135deg,#b5541e,#7b2d10 60%,#1a0a05)",
    short:    "A yoga booking system where user easily book there yoga session and  book there session slot according to their preference.",
    full:     "A user-friendly yoga class booking system designed with a focus on cultural aesthetics and typography. Built using mernstack for dynamic content generation, this project allows users to easily book yoga sessions based on their preferences, while showcasing  content and culturally inspired design elements.",
    tech:     ["MERN Stack", "ExpressJs", "React", "Node.js", "MongoDB", "CSS3", "Figma"],
    live:     "https://yoga-flow-pearl.vercel.app/",
    github:   "",
    year:     "2026",
  },
